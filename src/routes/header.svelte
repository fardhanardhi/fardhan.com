...
<div class="pointer-events-none fixed top-0 right-0 h-svh content-end px-4 py-4">
  <ul
    class="menu menu-lg bg-base-100 border-base-content rounded-box pointer-events-auto border-2 shadow-xl"
  >
    <li>
      <a>
        <svg
